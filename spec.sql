...
It has been getting too hard to keep track of my sales in my trusty notebook so I was reffered to your company to help me out and keep track of my orders electronically and I am confident that you will do an
excellent job.

For each bike sold I need the customers name, address and phone number.
I need the bike company, size and color. I need to record the date I received the bike, the date I sold it and in what season I sold the bike. I need to keep track if I am selling a new or second hand bike. 
...
Q: Can one customer by more than one bike?
A: Yes, however it is recorded separately for each bike, who bought it and it can be on the same day they bought a different bike.
